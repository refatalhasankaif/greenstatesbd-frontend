        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-6">
              ...
              {isEditing ? (
                <>
                  <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:opacity-90 disabled:opacity-50 transition"
                  >
                    <Save size={16} />
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-slate-800 text-gray-900 dark:text-white rounded-lg hover:opacity-90 transition"
                  >
                    <X size={16} />
                    Cancel
                  </button>
          ...
          <div className="border-t border-border pt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              <User size={20} className="text-muted-foreground mt-0.5 shrink-0" />
            ...
            {/* Email */}
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              <Mail size={20} className="text-muted-foreground mt-0.5 shrink-0" />
              <div className="flex-1 min-w-0">
            ...
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg md:col-span-2">
              <ImageIcon size={20} className="text-muted-foreground mt-0.5 shrink-0" />
              <div className="flex-1 min-w-0">
                ...
                {isEditing ? (
                  ...
                  <p className="text-sm font-medium text-foreground truncate">{editForm.profileImage || "No image URL set"}</p>
                )}
              </div>
            </div>
            ...
            {/* Join Date */}
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              <Calendar size={20} className="text-muted-foreground mt-0.5 shrink-0" />
              <div>
            ...
            {/* Status */}
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              <div className={`w-3 h-3 rounded-full mt-1 ${user.isBlocked ? 'bg-red-500' : 'bg-green-500'}`} />
              <div>
          ...
          <div className="border-t border-border pt-6">
            ...
            <div className="grid gap-2 md:grid-cols-3">
              <Link href="/my-properties" className="p-3 bg-muted rounded-lg hover:border-primary border border-transparent transition">
              ...
              <Link href="/bids" className="p-3 bg-muted rounded-lg hover:border-primary border border-transparent transition">
              ...
              <Link href="/reports" className="p-3 bg-muted rounded-lg hover:border-primary border border-transparent transition">
